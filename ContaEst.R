...
PossibleArgNames<-c("counts", "freqs", "outfile", "maxsites", "nthr")
...
USAGE<-("counts\tSTR\tangsd/misc/contamination -k 1 output. Required.
	...
	Example call: Rscript ContaEst.R counts=example_counts freqs=HapMap.gz maxsites=500 nthr=20 outfile=outname
")
